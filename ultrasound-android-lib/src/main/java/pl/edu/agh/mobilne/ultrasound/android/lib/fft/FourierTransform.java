package pl.edu.agh.mobilne.ultrasound.android.lib.fft;
...
public abstract class FourierTransform {
    ...
    protected FourierTransform(int timeSize, float sampleRate) {
    ...
    public abstract void forward(short[] buffer);
